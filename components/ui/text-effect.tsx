...
const AnimationComponent: React.FC<{
  ...
  const content =
    per === 'line' ? (
      <motion.span variants={variants} className='block text-inherit'>
        {segment}
      </motion.span>
    ) : per === 'word' ? (
      <motion.span
      ...
      <motion.span className='inline-block whitespace-pre text-inherit'>
    ...
    <AnimatePresence mode='popLayout'>
      {trigger && (
        <MotionTag
          ...
          viewport={startOnView ? { once: true } : undefined}
          exit='exit'
