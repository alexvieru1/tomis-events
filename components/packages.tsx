    ...
    <section className="py-16 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl space-y-6 text-center">
          <h1 className="text-center text-4xl font-semibold lg:text-5xl font-heading text-[#E81ADE]">
            Pachete Personalizate
          </h1>
          <p className="text-muted-foreground">
            Alege pachetul care se potrivește cel mai bine nevoilor tale.
            Indiferent de dimensiunea evenimentului, avem soluția perfectă
            pentru o atmosferă de neuitat.
          </p>
        </div>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-6 md:mt-20">
          {packages.map((pkg, index) => (
            <Card
              key={index}
              className={`flex flex-col w-full md:w-[calc((100%-3rem)/3)] ${
                pkg.isPopular ? "relative border-[#E81ADE] shadow-lg" : ""
              }`}
            >
              {pkg.isPopular && (
              ...
              <CardFooter className="mt-auto">
                <Button
                  ...
                  className={`w-full ${
                    pkg.isPopular ? "bg-[#E81ADE] hover:bg-[#E81ADE]/90" : ""
                  }`}
                >
        ...
        <div className="mt-16 text-center space-y-6">
          ...
          <Button
            asChild
            size="lg"
            className="rounded-full bg-[#E81ADE] hover:bg-[#E81ADE]/90 text-white px-8"
          >
